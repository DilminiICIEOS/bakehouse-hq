...
WSGI_APPLICATION = 'bakery_hq.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Bakery HQ API',
    'DESCRIPTION': 'Production-grade bakery management system API',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'SCHEMA_PATH_PREFIX': '/api/v1/',
    'CONTACT': {
        'name': 'Bakery HQ Support',
...
# JWT Configuration
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=int(config('JWT_EXPIRATION_HOURS', default=8))),
    ...
    'JTI_ALGORITHM_CLAIM': None,
    'USER_ID_FIELD': 'id',
    'USER_ID_CLAIM': 'user_id',
    'USER_AUTHENTICATION_RULE': 'rest_framework_simplejwt.authentication.default_user_authentication_rule',
    'AUTH_TOKEN_CLASSES': ('rest_framework_simplejwt.tokens.AccessToken',),
    'TOKEN_BLACKLIST_MODELS': [],
}
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'bakery_hq.log',
